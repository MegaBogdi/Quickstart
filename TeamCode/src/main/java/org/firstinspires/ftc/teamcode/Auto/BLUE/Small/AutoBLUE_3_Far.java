...
//
//@Configurable
//@Autonomous(name = "AutonomieBLUE_3_far", group = "Auto Blue")
//public class AutoBLUE_3_Far extends CommandOpMode {
...
//    private Pose parkSafeFrontPos = new Pose(55.23364485981308,34.7943925233645,toRad180(90));
//
...
//                .addPath(new BezierLine(startPose,parkSafeFrontPos))
//                .setLinearHeadingInterpolation(startPose.getHeading(),parkPos.getHeading())
//                .build();
//
//
//
