...
//
//@Configurable
//@Autonomous(name = "AutonomieRED_0_far", group = "Auto RED")
//public class AutoRED_0_Far extends CommandOpMode {
//    private Pose startPose = new Pose(89.64485981308411,8.897196261682243,toRad180(90));
//    private Pose parkPos = new Pose(97.19626168224299,34.24299065420562,toRad180(90));
//
//    private Pose parkBoogy = new Pose(114.54205607476636,9.981308411214965,toRad180(90));
//
...
//                .addPath(new BezierLine(startPose,parkBoogy))
//                .setLinearHeadingInterpolation(startPose.getHeading(),parkBoogy.getHeading())
//                .build();
//
//
//
...
//                        new FollowPathCommand(follower, StartToParkPath).setHoldEnd(true).beforeStarting(()->follower.setMaxPower(0.8))
//
//                )
//        );
//
