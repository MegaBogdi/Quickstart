...
public class AutoRED9_SHORT_SAFE extends CommandOpMode {
    ...
    private PathChain spike1ToPreLeverPath;
    private PathChain preLeverToLeverPath;
    ...
    public void initialize() {
        ...
        spike1ToPreLeverPath = follower.pathBuilder()
                .addPath(new BezierLine(
                        spike1Pos,
                        preLeverPos
                ))
                ...
                .build();
        preLeverToLeverPath = follower.pathBuilder()
                .addPath(new BezierLine(
                        preLeverPos,
                        lever2Pos
                ))
        ...
        schedule(
                ...
                new SequentialCommandGroup(
                        ...
                        new FollowPathCommand(follower, spike1ToPreLeverPath)
                                .beforeStarting(() -> follower.setMaxPower(1)),
                        new FollowPathCommand(follower, preLeverToLeverPath).withTimeout(800)
                                .beforeStarting(() -> follower.setMaxPower(1)),
                        ...
                        new FollowPathCommand(follower, shootToSpike2Path)
                                ...
                                .andThen(utils.newStopIntake())
                                .andThen(new InstantCommand(()->{if (IO.ocupied()>=3){IO.setLed(0.5);} else {IO.setLed(0.277);}})),
                        new FollowPathCommand(follower, spike2ToLeverPath).withTimeout(1000)
                                .beforeStarting(() -> follower.setMaxPower(1)),
                        new WaitCommand(1500),
                        new FollowPathCommand(follower, leverToShootPath)
                                .beforeStarting(() -> follower.setMaxPower(0.9)),
                        ...
                        new InstantCommand(() -> {
                            SharedUtils.sharedPose = follower.getPose(); IO.setLed(0.722);
                            //IO.offsetGoal(true,15,-5);
                        })
                )
        );
    }
