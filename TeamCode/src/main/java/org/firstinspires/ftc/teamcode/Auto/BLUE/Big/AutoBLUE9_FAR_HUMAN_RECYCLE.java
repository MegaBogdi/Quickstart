...
@Configurable
@Autonomous(name = "AutonomieBLUE_9_FAR_HUMAN_RECYLE", group = "Auto Blue")
public class AutoBLUE9_FAR_HUMAN_RECYCLE extends CommandOpMode {
    ...
    private Pose recyclePos = new Pose(9.121495327102803, 55.4953271028037, Math.toRadians(90));
    ...
    private PathChain shootFarToRecyclePath;
    private PathChain recycleToShootFarPath;
...
//                .build();
        ...
        shootFarToRecyclePath = follower.pathBuilder()
                .addPath(new BezierCurve(
                        shootFarPos,
                        new Pose(4.934612149532713,0.2804205607476753),
                        recyclePos
                        ))
        ...
        recycleToShootFarPath = follower.pathBuilder()
                .addPath(new BezierLine(
                        shootFarPos,
                        recyclePos
                ))
...
//                        utils.newAutoOutake(4500,2),
                        ...
                        new FollowPathCommand(follower,shootFarToRecyclePath)
                                .beforeStarting(()->follower.setMaxPower(0.8))
                                .alongWith(utils.newStartIntake(4000))
                                .andThen(utils.newStopIntake()),
                        new FollowPathCommand(follower,recycleToShootFarPath),
                        new WaitCommand(300),
                        utils.newAutoOutake(3000,2),
