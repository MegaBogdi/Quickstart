...
//@Configurable
//@Autonomous(name = "AutonomieBLUE_9", group = "Auto Blue")
//public class AutoBLUE9 extends CommandOpMode {
...
//                .addPath(new BezierLine(shootPos,parkSafePos))
//                .setLinearHeadingInterpolation(shootPos.getHeading(),parkSafePos.getHeading())
//                .build();
//
//
//        schedule(
