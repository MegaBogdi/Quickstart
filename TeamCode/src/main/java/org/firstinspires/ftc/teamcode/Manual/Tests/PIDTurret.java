...
public class PIDTurret extends CommandOpMode {
    ...
    public void run() {
        ...
        telemetry.addData("TicksTarget",IO.getTurretTarget());
        telemetry.addData("Ticks2Rads",IO.getTurretTarget());
        telemetry.addData("Rads2Ticks",IO.rads2ticks(IO.targetTurret));
        telemetry.addData("Transform",IO.getTurretTarget());
        telemetry.addData("Degrees",IO.getTurretTarget());
